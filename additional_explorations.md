...
[EXPLAINER.md](https://github.com/w3c/window-management/blob/main/explainer.md).
...
* Video conferencing window wishes to be [always-on-top](https://github.com/w3c/window-management/issues/10)
...
* `hdrMetadataTypes`: The display's supported high dynamic range metadata types.
  ...
  * May also be expressed as minimum luminance, maximum SDR luminance,
    ...
    [#20](https://github.com/w3c/window-management/issues/20#issuecomment-847451686))
